...
class AccessControlSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roleDefinitions = [
            ...
            'organizer' => ['Organiser', ['dashboard.view', 'profile.update', 'organisers.view', 'organisers.update', 'contacts.view', 'contacts.create', 'contacts.update', 'contacts.export', 'emails.view', 'emails.create', 'emails.send', 'reports.view', 'reports.create', 'reports.export', 'events.view', 'events.create', 'events.update', 'events.submit', 'events.publish', 'registration_forms.view', 'registration_forms.manage', 'registrations.view', 'registrations.create', 'registrations.update', 'registrations.invite', 'attendance.view', 'attendance.scan', 'attendance.override', 'attendance.export']],
