...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap gap-3"><button class="min-h-11 rounded-lg bg-emerald-700 px-4 text-sm font-semibold text-white hover:bg-emerald-800">{{ $button ?? 'Save event' }}</button><a href="{{ route('admin.events.index') }}" class="inline-flex min-h-11 items-center rounded-lg border border-slate-300 px-4 text-sm font-semibold hover:bg-slate-50">Cancel</a></div>
</div>
<script>
