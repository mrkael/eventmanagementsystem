<x-layouts.admin title="Event Page Builder" heading="Event Page Builder" subheading="{{ $event->title }}">
    ...
    <form method="POST" action="{{ route('admin.events.builder.publish',$event) }}" class="mt-4">@csrf<button class="min-h-11 rounded-lg bg-blue-700 px-4 text-sm font-semibold text-white">Publish Event Page</button></form>
    <script>
