...
<div class="mt-6 flex flex-wrap gap-3">
    <button type="submit" class="btn btn-primary btn-md">{{ $button ?? 'Save permission' }}</button>
    <a href="{{ route('admin.permissions.index') }}" class="btn btn-outline-primary btn-md">Cancel</a>
</div>
